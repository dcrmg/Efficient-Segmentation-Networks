...
from model.ESPNet_v2.espnet_utils import *
from model.ESPNet_v2.efficient_pyramid_pool import EfficientPyrPool
from model.ESPNet_v2.efficient_pt import EfficientPWConv
from model.ESPNet_v2.espnetv2 import EESPNet
from model.ESPNet_v2.print_utils import *
...
if __name__ == "__main__":
    ...
    from model.ESPNet_v2.utils import compute_flops, model_parameters
    import torch
    ...
    input = torch.Tensor(1, 3, 480, 480)
    model = espnetv2_seg(args, 150)
    from model.ESPNet_v2.utils import compute_flops, model_parameters
